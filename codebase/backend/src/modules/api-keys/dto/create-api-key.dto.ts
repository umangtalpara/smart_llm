...
export class CreateApiKeyDto {
  ...
  @ApiProperty({
    ...
    description: 'The raw provider API Key',
  })
  ...
  @ApiProperty({
    example: 0,
    description: 'Daily limit cap (0 for unlimited)',
    required: false,
  })
  ...
  @ApiProperty({
    example: 0,
    description: 'Requests per minute cap (0 for unlimited)',
    required: false,
  })
  ...
  @ApiProperty({
    example: 0,
    description: 'Tokens per minute cap (0 for unlimited)',
    required: false,
  })
  ...
  @ApiProperty({
    example: 1,
    description: 'Priority level (higher is chosen first)',
    required: false,
  })
  ...
  @ApiProperty({
    example: ['free', 'dev'],
    description: 'Friendly tags to filter keys',
    required: false,
  })

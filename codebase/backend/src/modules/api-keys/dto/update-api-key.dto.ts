...
export class UpdateApiKeyDto {
  ...
  @ApiProperty({
    example: 'sk-proj-...yyyy',
    description: 'Update the raw API Key value',
    required: false,
  })
  ...
  @ApiProperty({
    enum: KeyStatus,
    example: KeyStatus.INACTIVE,
    description: 'Directly modify key status',
    required: false,
  })
  ...
  @ApiProperty({
    example: 0,
    description: 'Tokens per minute cap',
    required: false,
  })
